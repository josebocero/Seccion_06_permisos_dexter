package jose_g_bocero.com.jose.seccion_06_permisos_dexter
...
import jose_g_bocero.com.jose.seccion_06_permisos_dexter.enums.PermissionStatusEnum
...
//    private fun checkCameraPermissions() = setCameraPermissionHandlerWithDialog()
    ...
    private fun setCameraPermissionHandlerWithSnackBar() {
        ...
        val snackbarPermissionListener = SnackbarOnDeniedPermissionListener.Builder.with(root, "Camera is needed to take pictures").withOpenSettingsButton("Settings").withCallback(object : Snackbar.Callback() {
